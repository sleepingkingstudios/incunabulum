...
At the DM's discretion, a character may be able to convert an existing multiclass into a secondary class, allowing them to gain a level in their primary class instead.

[Character Boons]({{site.baseurl}}/systems/5e/variants/character-boons) provide an alternative to gaining or leveling a secondary class. Each time a character could gain a level in a secondary class, they can instead choose one of the following boons, based on the character's total level.
